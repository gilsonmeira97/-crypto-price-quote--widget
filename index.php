...
<head>
	...
	<?php 
		...
		$bitcoin = $client->simple()->getPrice('0x,bitcoin', 'usd');
		$ethereum = $client->simple()->getPrice('0x,ethereum', 'usd');
		$cardano = $client->simple()->getPrice('0x,cardano', 'usd');
		$monero = $client->simple()->getPrice('0x,monero', 'usd');
		$litecoin = $client->simple()->getPrice('0x,litecoin', 'usd');
		$dogecoin = $client->simple()->getPrice('0x,dogecoin', 'usd');
	?>
</head>
<body>
	<div class="grid-cotacao">
		<div class="ativos">
			<span class="name-ativo">Bitcoin</span>
			<p class="symbol">
				<svg width="24px" height="24px" viewbox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" class="bi bi-currency-bitcoin">
		...
		<div class="ativos">
			<span class="name-ativo">Ethereum</span>
			<p class="symbol">
				<svg width="24px" height="24px" viewbox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg"><title>Ethereum icon</title><path d="M11.944 17.97L4.58 13.62 11.943 24l7.37-10.38-7.372 4.35h.003zM12.056 0L4.69 12.223l7.365 4.354 7.365-4.35L12.056 0z"/></svg>
			</p>
			<p class="price-ativo">
				$ 3800.00
			</p>
	...
	<script>
		...
		document.querySelectorAll('.price-ativo')[0].innerText = formatarValor(`<?php print ($bitcoin[bitcoin][usd]); ?>`)
		document.querySelectorAll('.price-ativo')[1].innerText = formatarValor(`<?php print ($ethereum[ethereum][usd]); ?>`)
		document.querySelectorAll('.price-ativo')[2].innerText = formatarValor(`<?php print ($cardano[cardano][usd]); ?>`)
		document.querySelectorAll('.price-ativo')[3].innerText = formatarValor(`<?php print ($monero[monero][usd]); ?>`)
		document.querySelectorAll('.price-ativo')[4].innerText = formatarValor(`<?php print ($litecoin[litecoin][usd]); ?>`)
		document.querySelectorAll('.price-ativo')[5].innerText = formatarValor(`<?php print ($dogecoin[dogecoin][usd]); ?>`)
	</script>
</body>
</html>